...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5    
    ...
    TabsC.color-secundario(data-aos="fade-left")
      .p-4(titulo='Plan de salud pública - PDSP 2012-2021 ')
        .row(style='justify-content: space-around')
          .col-lg-5.mb-4.mb-lg-0.align-self-top
      ...
      .p-4(titulo='Política de Seguridad del Paciente')
        .row(style='justify-content: center')
      ...
      .p-4(titulo='Política Atención Integral de Salud - MAITE – RIAS')
        .row(style='justify-content: center')
          .col-lg-6.mb-4.mb-lg-0.align-self-top
