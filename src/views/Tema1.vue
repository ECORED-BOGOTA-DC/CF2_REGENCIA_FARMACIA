...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
          ...
          .row.justify-content-around.align-items-center
            ...
            .col-md.col-lg-6
              ...
              a.boton.color-acento-botones(
                ...
                span(style='color: #12263f') Sistema de salud colombiano
    ...
    .row.justify-content-center.mb-5
      .col-lg-9.mb-4.mb-lg-0(data-aos="fade-up-right")
    ...
    TabsC.color-secundario.mb-5(data-aos="fade-right")
      .py-3.py-md-5(titulo='Universalidad')
        .row(style='justify-content: center')
          .col-md-6.mb-4.mb-md-0.align-self-center
            h2 Universalidad
            p Se refiere a la garantía de la protección para todas las personas, sin <b>ninguna discriminación,</b> en todas las etapas de su vida.
          .col-md-5
            figure
              img.mx-auto(
    ...
    p.mb-4(data-aos="fade-right") El SGSSS adiciona nuevos principios que, a su vez, se aplican como reglas, para su óptimo desarrollo; estos principios adicionales son:
    .row.align-items-center(style='justify-content: space-between')
      .col-lg-4.mb-4.mb-lg-0
        figure
          img.mx-auto(
      ...
      .col-lg-7(data-aos="fade-left")
        LineaTiempoD.color-secundario
          p.text-medium(numero='1', titulo='Equidad ') Servicios de salud, con una <b>calidad igual</b> para todos los colombianos.
          p.text-medium(numero='2', titulo='Obligatoriedad') Afiliación al S.G.S.S.S. <b>obligatoria</b> para todos los colombianos.
          p.text-medium(numero='3', titulo='Protección integral') Atención en salud integral: educación, información, prevención de la enfermedad, diagnóstico precoz, tratamiento oportuno, rehabilitación, en <b>cantidad, oportunidad, calidad y eficiencia.</b>
    ...
    .row.align-items-center.mb-5(style='justify-content: space-around')
    ...
    .row.justify-content-center.centro-fondo--arriba.mb-5
      .col-lg-12.ps-5.pe-5
        p.mb-4(data-aos="fade-right") Los actores que intervienen en el Sistema General de Seguridad Social en Salud, son:
    ...
    .row.justify-content-center.centro-fondo--arriba.mb-5
      .col-lg-12.ps-5.pe-5
        ...
        .row.justify-content-center
          .col-11
            .bloque-texto-a.color-secundario.p-4.p-md-4(data-aos="flip-up")
    ...
    .row.justify-content-center
      .col-lg-9.align-self-center(data-aos="fade-right")
        ...
        a.anexo(:href="obtenerLink('/downloads/DerechosyDeberes.pdf')" target="_blank")
          .anexo__icono
    ...
    .row.justify-content-center.mb-2
      ...
      .col-lg-8.align-self-center(data-aos="fade-left")
    ...
    TabsC.color-secundario.mb-5(data-aos="fade-left")
      ...
      .p-4(titulo='Mediana complejidad')
        .row(style='justify-content: space-around')
          .col-lg-5.mb-4.mb-lg-0.align-self-center
    ...
    TabsC.color-secundario.mb-5
      .p-4(titulo='Atención extramural')
        .row(style='justify-content: center')
      ...
      .p-4(titulo='Atención domiciliaria')
        .row(style='justify-content: center')
          .col-lg-6.mb-4.mb-lg-0.align-self-center
      ...
      .col-lg-12
        .row.align-items-center(style='justify-content:space-between')
            .col-lg-4(data-aos="fade-right")
              figure.mb-4
                img.mb-1.mx-auto(src='@/assets/curso/tema1/tema1-7/img12.png', alt='Imágen decorativa', style='width:250px').mx-auto
            .col-lg-7(data-aos="fade-left")
              LineaTiempoD.color-secundario
    ...
    .row.mb-5(style='justify-content:center')(data-aos="fade-left")
    ...
    TabsB.color-secundario(data-aos="fade-left")
      .p-4(titulo="Superintendencia Nacional de Salud" :icono="require('@/assets/curso/tema1/tema1-8/icon7.svg')")
        .row(style='justify-content: space-around; margin-bottom:80px; margin-top:60px;')
          ...
          .col-lg-3
            figure
              img.mx-auto(src='@/assets/curso/tema1/tema1-8/img1.svg', style="width:350px" ,alt='Muestra logo de Supersalud')
      .p-4(titulo="Entes territoriales / Entes de control" :icono="require('@/assets/curso/tema1/tema1-8/icon8.svg')")
        .row(style='justify-content: space-around; margin-bottom:80px; margin-top:60px;')
          .col-lg-7.mb-4.mb-lg-0
          ...
          .col-lg-3
            figure
              img.mx-auto(src='@/assets/curso/tema1/tema1-8/img2.svg', style="width:350px" ,alt='Muestra imagen de ente territorial de salud')
      .p-4(titulo="INVIMA" :icono="require('@/assets/curso/tema1/tema1-8/icon9.svg')")
        .row(style='justify-content: space-around; margin-bottom:80px; margin-top:60px;')
          .col-lg-7.mb-4.mb-lg-0
            h1.mb-4 INVIMA
          ...
          .col-lg-3
            figure
              img.mx-auto(src='@/assets/curso/tema1/tema1-8/img3.svg', style="width:350px" ,alt='Muestra logo Invima, instituto nacional de vigilancia de medicamentos y alimentos')
      .p-4(titulo="Instituto Nacional de Salud" :icono="require('@/assets/curso/tema1/tema1-8/icon10.svg')")
        .row(style='justify-content: space-around; margin-bottom:80px; margin-top:60px;')
          .col-lg-7.mb-4.mb-lg-0
          ...
          .col-lg-3
            figure
              img.mx-auto(src='@/assets/curso/tema1/tema1-8/img4.svg', style="width:350px" ,alt='Muestra logo instituto nacional de salud')
    .row.justify-content-center.centro-fondo--arriba
      .col-lg-12.ps-5.pe-5
        separador
        ...
        .row.justify-content-center.mb-5
          .col-lg-3.mb-2(data-aos="fade-right")
            figure
        ...
        .row.justify-content-center.align-items-center
          ...
          .col-lg-4(data-aos="fade-left")
            figure
              img.mx-auto(src='@/assets/curso/tema1/tema1-9/img2.svg', alt='Imágen decorativa', style='width:300px')
    ...
    TabsC.color-secundario(data-aos="fade-right")
      .p-4(titulo='Copagos')
        .row(style='justify-content: center')
          .col-lg-6.mb-4.mb-lg-0.align-self-center
            h2 Copagos
      ...
      .p-4(titulo='Cuotas moderadas')
        .row.align-items-center(style='justify-content: center')
          .col-lg-6.mb-4.mb-lg-0.align-self-center
            h2 Cuotas moderadas
      ...
      .p-4(titulo='Cuotas de recuperación')
        .row.align-items-center(style='justify-content: center')
          .col-lg-6.mb-4.mb-lg-0.align-self-center
