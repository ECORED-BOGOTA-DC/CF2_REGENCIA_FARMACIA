...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.fondo-esquina.pt-4.px-5
      .col-lg-11
        ...
        .bloque-texto-b.color-primario.p-4.ms-4.mb-5(data-aos="flip-down")
          .bloque-texto-b__texto
            ...
            .bloque-texto-d__autor
              .h5.mb-0.d-flex.justify-content-end - Artículo 19 Ley 1751 de 2015.
    ...
    p.mb-4(data-aos="fade-right") La Guía Técnica de información G.Inf. 06, define calidad de datos como el ámbito enfocado en el aseguramiento de la calidad, para garantizar la prestación de servicios de información e institucionales, a través de la identificación y propuesta de mejoras, la modificación del modelo operativo y la actualización y verificación del cumplimiento de los indicadores de calidad, definidos para el dato.
    .row.justify-content-center
      .col-lg-4.align-self-center
        figure(data-aos="fade-right")
          img.mb-4.mb-lg-0.mx-auto(
